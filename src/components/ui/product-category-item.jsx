...
export const ProductItem = ({
  ...
  return (
    <ItemWrapper aria-disabled={!productActive}>
      <div onClick={productActive ? onClick : null}>
        <PhotoWrapper>
        ...
        <div className="productDesc">
          ...
          <div>
            <p className="productName">{name || 'No Name'}</p>
          </div>
    ...
    >
      ...
      <div className="productDesc">
        ...
        <div className="priceWrapper">
          ...
          <Favorite className="favIcons" />
        </div>

        {/* <div className="buttonWrapper">
          <StyledButton mt="0" height="42px" width="100%">
            + Keranjang
          </StyledButton>
        </div> */}
      </div>
