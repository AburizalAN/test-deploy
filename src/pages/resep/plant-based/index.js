...
export default function PlantBased() {
  ...
  useEffect(() => {
    dispatch(ACTIONS.recipe.getListSubcategory('plant-based'));
    dispatch(ACTIONS.recipeCatalog.getListRecipeCatalog('plant-based'));
  }, []);

  return (
    <Box>
      <TopNavDetail title={'Plant Based'} disableSearch />
      <CategoryLink categories={categoryList} headCategory={'plant-based'} />
