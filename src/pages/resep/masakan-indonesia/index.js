...
export default function PlantBased() {
  ...
  useEffect(() => {
    dispatch(ACTIONS.recipe.getListSubcategory('masakan-indonesia'));
    dispatch(ACTIONS.recipeCatalog.getListRecipeCatalog('masakan-indonesia'));
  }, []);

  return (
    <Box>
      <TopNavDetail title={'Masakan Indonesia'} disableSearch />
      <CategoryLink
        categories={categoryList}
        headCategory={'masakan-indonesia'}
      />
