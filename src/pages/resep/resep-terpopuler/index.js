...
export default function PlantBased() {
  ...
  useEffect(() => {
    dispatch(ACTIONS.recipe.getListSubcategory('resep-terpopuler'));
    dispatch(ACTIONS.recipeCatalog.getListRecipeCatalog('resep-terpopuler'));
  }, []);

  return (
    <Box>
      <TopNavDetail title={'Resep Terpopuler'} disableSearch />
      <CategoryLink
        categories={categoryList}
        headCategory={'resep-terpopuler'}
      />
