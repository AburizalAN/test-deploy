...
export default function PlantBased() {
  ...
  useEffect(() => {
    dispatch(ACTIONS.recipe.getListSubcategory('cemilan-sehat'));
    dispatch(ACTIONS.recipeCatalog.getListRecipeCatalog('cemilan-sehat'));
  }, []);

  return (
    <Box>
      <TopNavDetail title={'Cemilan Sehat'} disableSearch />
      <CategoryLink categories={categoryList} headCategory={'cemilan-sehat'} />
