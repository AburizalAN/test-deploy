...
export default function PlantBased() {
  ...
  useEffect(() => {
    dispatch(ACTIONS.recipe.getListSubcategory('sarapan-sehat'));
    dispatch(ACTIONS.recipeCatalog.getListRecipeCatalog('sarapan-sehat'));
  }, []);

  return (
    <Box>
      <TopNavDetail title={'Sarapan Sehat'} disableSearch />
      <CategoryLink categories={categoryList} headCategory={'sarapan-sehat'} />
