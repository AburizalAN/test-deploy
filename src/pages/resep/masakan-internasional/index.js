...
export default function PlantBased() {
  ...
  useEffect(() => {
    dispatch(ACTIONS.recipe.getListSubcategory('masakan-internasional'));
    dispatch(
      ACTIONS.recipeCatalog.getListRecipeCatalog('masakan-internasional')
    );
  }, []);

  return (
    <Box>
      <TopNavDetail title={'Masakan Internasional'} disableSearch />
      <CategoryLink
        categories={categoryList}
        headCategory={'masakan-internasional'}
      />
